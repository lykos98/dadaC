...
gt_density_kstar = np.loadtxt(
    os.path.join(os.path.dirname(__file__), "gt/gt_density_kstar.dat")
)
gt_density_kstar_err = np.loadtxt(
    os.path.join(os.path.dirname(__file__), "gt/gt_density_kstar_err.dat")
)
gt_kstar = np.loadtxt(os.path.join(os.path.dirname(__file__), "gt/gt_kstar.dat"))

gt_density_PAk = np.loadtxt(
    os.path.join(os.path.dirname(__file__), "gt/gt_density_PAk.dat")
)
gt_density_PAk_err = np.loadtxt(
    os.path.join(os.path.dirname(__file__), "gt/gt_density_PAk_err.dat")
)
